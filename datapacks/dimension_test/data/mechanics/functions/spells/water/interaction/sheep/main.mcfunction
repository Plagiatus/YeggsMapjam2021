...
execute if score @s timer matches 5 run replaceitem entity @e[type=armor_stand,limit=1,sort=nearest,tag=cloud_sheep,distance=..1] armor.head leather_horse_armor{CustomModelData:1,display:{color:16765440}}
execute if score @s timer matches 5 run function mechanics:spells/water/interaction/sheep/ambient
execute if score @s timer matches 20 run replaceitem entity @e[type=armor_stand,limit=1,sort=nearest,tag=cloud_sheep,distance=..1] armor.head leather_horse_armor{CustomModelData:2,display:{color:16765440}}
execute if score @s timer matches 20 run function mechanics:spells/water/interaction/sheep/ambient
execute if score @s timer matches 45 run replaceitem entity @e[type=armor_stand,limit=1,sort=nearest,tag=cloud_sheep,distance=..1] armor.head leather_horse_armor{CustomModelData:3,display:{color:16765440}}
...
execute if score @s timer matches 75..450 run particle rain ~ ~ ~ 1 0 1 1 2
...
execute if score @s timer matches 510 run replaceitem entity @e[type=armor_stand,limit=1,sort=nearest,tag=cloud_sheep,distance=..1] armor.head leather_horse_armor{CustomModelData:2,display:{color:16765440}}
execute if score @s timer matches 530 run replaceitem entity @e[type=armor_stand,limit=1,sort=nearest,tag=cloud_sheep,distance=..1] armor.head leather_horse_armor{CustomModelData:1,display:{color:16765440}}
