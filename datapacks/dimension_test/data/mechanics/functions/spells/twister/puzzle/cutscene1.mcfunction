...
execute if score @s timer matches 40 run playsound block.wet_grass.place block @a
...
execute if score @s timer matches 60 run playsound block.wet_grass.place block @a
