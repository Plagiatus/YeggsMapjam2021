...
execute if score @s build matches 4 unless entity @e[tag=preview,dx=0,dy=0,dz=0] align xyz positioned ~.5 ~ ~.5 run summon armor_stand ~ ~ ~ {NoBasePlate:1b,Invisible:1b,NoGravity:1b,Invulnerable:1b,Marker:1b,Tags:["preview"],ArmorItems:[{},{},{},{id:"white_stained_glass_pane",Count:1b,tag:{CustomModelData:6}}]}
